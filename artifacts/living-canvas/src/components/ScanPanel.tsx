...
export default function ScanPanel({ onClose }: ScanPanelProps) {
  ...
  const handleBrowse = async () => {
    ...
    try {
      ...
      setError((err as Error)?.message || 'Erro ao escanear projeto');
      setPhase('error');
    }
  };
        ...
        <div style={{ padding: '18px' }}>
          {phase === 'idle' || phase === 'error' ? (
              ...
              >
                ...
                <div>
                  ...
                  <div style={{ fontSize: '9px', color: '#2e3340', marginTop: '2px' }}>
                    Suporta Next.js 13+ (App Router) e Next.js 12 (Pages Router)
                  </div>
                </div>
              </button>
            ...
            <div style={{ padding: '40px 0', textAlign: 'center' }}>
              ...
              <div style={{ fontSize: '12px', color: '#4b5563', fontFamily: 'monospace' }}>Escaneando estrutura do projeto...</div>
              <div style={{ fontSize: '9px', color: '#2e3340', marginTop: '4px' }}>Lendo arquivos e mapeando arquitetura</div>
            </div>
          ) : phase === 'done' && result ? (
            <>
              {/* Result preview */}
